...
/**
 * The class <code>Era</code> represents a calendar era that defines a period of
 * time in which the same year numbering is used. For example, Gregorian year
 * 2004 is <I>Heisei</I> 16 in the Japanese calendar system. An era starts at
 * any point of time (Gregorian) that is represented by
 * <code>CalendarDate</code>.
 * 
 * <p>
 * <code>Era</code>s that are applicable to a particular calendar system can be
 * obtained by calling {@link CalendarSystem#getEras} one of which can be used
 * to specify a date in <code>CalendarDate</code>.
 * 
 * <p>
 * The following era names are defined in this release. <!-- TODO: use HTML
 * table -->
 * 
 * <pre>
 * <tt>
...
public final class Era {
	 ...
	 * 
	 * @param name
	 *            the era name (e.g., "BeforeCommonEra" for the Julian calendar
	 *            system)
	 * @param abbr
	 *            the abbreviation of the era name (e.g., "B.C.E." for
	 *            "BeforeCommonEra")
	 * @param since
	 *            the time (millisecond offset from January 1, 1970 (Gregorian)
	 *            UTC or local time) when the era starts, inclusive.
	 * @param localTime
	 *            <code>true</code> if <code>since</code> specifies a local
	 *            time; <code>false</code> if <code>since</code> specifies UTC
	 */
	...
	public long getSince(TimeZone zone) {
		if (zone == null || !localTime) { return since; }
	...
	public boolean equals(Object o) {
		if (!(o instanceof Era)) { return false; }
		Era that = (Era) o;
