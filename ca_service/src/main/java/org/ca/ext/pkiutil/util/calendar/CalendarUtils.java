...
public class CalendarUtils {
	...
	/**
	 * Divides two integers and returns the floor of the quotient. For example,
	 * <code>floorDivide(-1, 4)</code> returns -1 while -1/4 is 0.
	 * 
	 * @param n
	 *            the numerator
	 * @param d
	 *            a divisor that must be greater than 0
	...
	/**
	 * Divides two integers and returns the floor of the quotient and the
	 * modulus remainder. For example, <code>floorDivide(-1,4)</code> returns
	 * <code>-1</code> with <code>3</code> as its remainder, while
	 * <code>-1/4</code> is <code>0</code> and <code>-1%4</code> is
	 * <code>-1</code>.
	 * 
	 * @param n
	 *            the numerator
