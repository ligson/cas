...
import org.ca.ext.security.util.DerEncoder;
...
public class AlgorithmId implements Serializable, DerEncoder {
	...
	protected void decodeParams() throws IOException {
		...
		this.algParams.init(params.toByteArray());
	}
	...
	private static ObjectIdentifier oid(int... components) {
		return ObjectIdentifier.newInternal(components);
	}

	private static ObjectIdentifier oid(String oid) {
		String[] componentsString = oid.split("\\.");
		int[] components = new int[componentsString.length];
		for (int i = 0; i < components.length; i++) {
			components[i] = Integer.valueOf(componentsString[i]).intValue();
		}
	...
	/**
	 * Algorithm ID for the SM2 SM3 encryption algorithms
	 */
	public static final ObjectIdentifier SM2_oid = oid(1, 2, 156, 10197, 1, 301);
	public static final ObjectIdentifier SM3withSM2_oid = oid(1, 2, 156, 10197,
			1, 501);
	public static final ObjectIdentifier SM3_oid = oid(1, 2, 156, 10197, 1, 401);

	/* {iso(1) member-body(2) unassigned(110)} */
	public static final ObjectIdentifier UNASSIGNED = oid("1.2.110");
	...
	static {
		...
		nameTable.put(SM2_oid, "SM2");// prime256v1
		nameTable.put(SM3_oid, "SM3");
