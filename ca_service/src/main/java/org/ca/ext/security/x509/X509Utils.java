...
public static byte[] calculateSignature(
            DERObjectIdentifier sigOid,
            String sigName,
            PrivateKey key,
            SecureRandom random,
        ...
        sig = X509Utils.getSignatureInstance(sigName);
...
public static byte[] calculateSignature(
        ...
        sig = X509Utils.getSignatureInstance(sigName, provider);
...
public static X509Principal convertPrincipal(
