...
/**
 * This class implements encoding and decoding of Elliptic Curve parameters as
...
public class ECParameters extends AlgorithmParametersSpi {
	...
	// Copied from the TopPKCS11 code - should be moved to a common location.
	...
	public static NamedCurve getNamedCurve(ECParameterSpec params) {
		...
		// This is a hack to allow TopJSSE to work with 3rd party crypto
		// providers for ECC and not just TopPKCS11.
		...
		// the TopJSSE TLS ECC extensions are wrong, which could lead to
	...
	protected void engineInit(AlgorithmParameterSpec paramSpec)
		...
		if (paramSpec instanceof ECParameterSpec) {
			...
			if (spec == null) {
				throw new InvalidParameterSpecException("Unknown curve: "
						+ name);
			}
			this.paramSpec = spec;
	...
	protected <T extends AlgorithmParameterSpec> T engineGetParameterSpec(
			Class<T> spec) throws InvalidParameterSpecException {
