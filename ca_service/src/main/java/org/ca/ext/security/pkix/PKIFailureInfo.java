package org.ca.ext.security.pkix;
...
public class PKIFailureInfo {
    ...
    private org.bouncycastle.asn1.cmp.PKIFailureInfo info;
    ...
    public PKIFailureInfo(
        int info)
    {
        this.info = new org.bouncycastle.asn1.cmp.PKIFailureInfo(info);
    }

    public String toString()
    {
        return "PKIFailureInfo: 0x" + Integer.toHexString(info.intValue());
    }
