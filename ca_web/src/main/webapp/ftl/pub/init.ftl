<@override name="title">初始化管理员</@override>
...
<script type="text/javascript" src="${assetsPath}js/cas/user/register.js"></script>
</@override>
<@override name="body">
<div class="col-sm-2"></div>
<form id="register_form" class="form-horizontal col-sm-8" action="${basePath}init.do" method="post">
